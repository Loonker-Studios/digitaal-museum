# source: https://lemmasoft.renai.us/forums/viewtopic.php?t=37628

# note: renpy has some default transitions (https://www.renpy.org/doc/html/transitions.html)
...
init:
    ...
    $ puzz = ImageDissolve("wipes/puzz.png", 1.0, 8)
    
    $ shatter = ImageDissolve("wipes/shatter.png", 1.0, 8)
    $ shot = ImageDissolve("wipes/shot.png", 1.0, 8)

    $ roundin = ImageDissolve("wipes/round-in.png", 1.0, 0)
    $ roundout = ImageDissolve("wipes/round-out.png", 1.0, 0)
    $ ringsin = ImageDissolve("wipes/rings-in.png", 1.0, 0)
    $ ringsout = ImageDissolve("wipes/rings-out.png", 1.0, 0)

    $ eyesopen = ImageDissolve("wipes/eye.png", 1.25, 4)
    $ eyesopen_fast = ImageDissolve("wipes/eye.png", .5, 4)
    $ eyesclosed = ImageDissolve("wipes/eye.png", 1.25, 4, reverse=True)
    $ eyesclosed_fast = ImageDissolve("wipes/eye.png", .5, 4, reverse=True)

    $ wipe = ImageDissolve("wipes/wipe.png", 1.0, 8)
    $ verticallines = ImageDissolve("wipes/018.jpg", 1.0, 8)
    $ actionlines = ImageDissolve("wipes/008.jpg", .35, 8)

    $ w009 = ImageDissolve("wipes/009.jpg", 1.25, 8)

    $ w007 = ImageDissolve("wipes/007.png", 1.0, 8)
    $ w015 = ImageDissolve("wipes/015.jpg", 1.0, 8)

    # unnamed
    $ w1 = ImageDissolve("wipes/1.jpg", 1.0, 8)
    $ w2 = ImageDissolve("wipes/2.png", 1.0, 8)
    $ dream = ImageDissolve("wipes/002.jpg", 2.0, 4)
    ...
    $ turnfast = ImageDissolve("wipes/9.jpg", 1.0, 8)
